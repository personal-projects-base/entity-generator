# Handoff para o frontend — contratos do entity-generator

## Objetivo

O frontend deve ser capaz de montar um fragmento JSON com entidades, campos, relacionamentos, endpoints e enums. Esse fragmento será colado nas respectivas listas do `properties.json` do backend.
